...
import { CollectionProp, GetAppDefinitionParams, GetAppInstallationParams, GetCommentParams, GetContentTypeParams, GetEditorInterfaceParams, GetOrganizationMembershipParams, GetOrganizationParams, GetSnapshotForContentTypeParams, GetSnapshotForEntryParams, GetSpaceEnvAliasParams, GetSpaceEnvironmentParams, GetSpaceMembershipProps, GetSpaceParams, GetTagParams, GetTeamMembershipParams, GetTeamParams, GetTeamSpaceMembershipParams, GetExtensionParams, GetWebhookCallDetailsUrl, GetWebhookParams, KeyValueMap, PaginationQueryParams, QueryParams, GetAppUploadParams, GetAppActionParams, GetAppActionCallParams, GetAppBundleParams, GetBulkActionParams, GetReleaseParams, GetTaskParams, GetEntryParams, CursorPaginatedCollectionProp, GetWorkflowDefinitionParams, GetAppActionsForEnvParams, GetUserUIConfigParams, GetUIConfigParams, GetEnvironmentTemplateParams, BasicCursorPaginationOptions, EnvironmentTemplateParams, GetAppActionCallDetailsParams } from '../common-types';
import { ApiKeyProps, CreateApiKeyProps } from '../entities/api-key';
import { AppDefinitionProps, AppInstallationsForOrganizationProps, CreateAppDefinitionProps } from '../entities/app-definition';
...
import { CreateCommentParams, CreateCommentProps, DeleteCommentParams, CommentProps, UpdateCommentParams, UpdateCommentProps, GetManyCommentsParams, RichTextBodyFormat, RichTextCommentProps, RichTextCommentBodyPayload, PlainTextBodyFormat } from '../entities/comment';
...
import { AppActionCallProps, AppActionCallResponse, CreateAppActionCallProps } from '../entities/app-action-call';
...
import { CreateWorkflowDefinitionParams, CreateWorkflowDefinitionProps, DeleteWorkflowDefinitionParams, UpdateWorkflowDefinitionParams, UpdateWorkflowDefinitionProps, WorkflowDefinitionProps, WorkflowDefinitionQueryOptions } from '../entities/workflow-definition';
import { CompleteWorkflowParams, CreateWorkflowParams, CreateWorkflowProps, DeleteWorkflowParams, UpdateWorkflowParams, UpdateWorkflowProps, WorkflowProps, WorkflowQueryOptions } from '../entities/workflow';
import { WorkflowsChangelogEntryProps, WorkflowsChangelogQueryOptions } from '../entities/workflows-changelog-entry';
import { UserUIConfigProps } from '../entities/user-ui-config';
import { UIConfigProps } from '../entities/ui-config';
import { CreateEnvironmentTemplateProps, EnvironmentTemplateProps } from '../entities/environment-template';
import { CreateEnvironmentTemplateInstallationProps, EnvironmentTemplateInstallationProps, EnvironmentTemplateValidationProps, ValidateEnvironmentTemplateInstallationProps } from '../entities/environment-template-installation';
export type PlainClientAPI = {
    ...
    appAction: {
        ...
        getMany(params: OptionalDefaults<GetAppDefinitionParams & QueryParams>): Promise<CollectionProp<AppActionProps>>;
        getManyForEnvironment(params: OptionalDefaults<GetAppActionsForEnvParams & QueryParams>): Promise<CollectionProp<AppActionProps>>;
    ...
    appActionCall: {
        ...
        getCallDetails(params: OptionalDefaults<GetAppActionCallDetailsParams>): Promise<AppActionCallResponse>;
    ...
    environment: {
        ...
        }>, rawData: CreateEnvironmentProps, headers?: AxiosRequestHeaders): Promise<EnvironmentProps>;
    ...
    environmentTemplate: {
        get(params: GetEnvironmentTemplateParams & {
            version?: number;
        ...
        versionUpdate(params: GetEnvironmentTemplateParams & {
            version: number;
        }, rawData: {
            versionName?: string;
        ...
        versions(params: GetEnvironmentTemplateParams & BasicCursorPaginationOptions, headers?: AxiosRequestHeaders): Promise<CursorPaginatedCollectionProp<EnvironmentTemplateProps>>;
        validate(params: EnvironmentTemplateParams & {
            version?: number;
        }, rawData: ValidateEnvironmentTemplateInstallationProps, headers?: AxiosRequestHeaders): Promise<EnvironmentTemplateValidationProps>;
    ...
    comment: {
        ...
        get(params: OptionalDefaults<GetCommentParams> & RichTextBodyFormat): Promise<RichTextCommentProps>;
        getMany(params: OptionalDefaults<GetManyCommentsParams & PlainTextBodyFormat & QueryParams>): Promise<CollectionProp<CommentProps>>;
        getMany(params: OptionalDefaults<GetManyCommentsParams & QueryParams & RichTextBodyFormat>): Promise<CollectionProp<RichTextCommentProps>>;
        ...
        create(params: OptionalDefaults<CreateCommentParams>, rawData: RichTextCommentBodyPayload, headers?: AxiosRequestHeaders): Promise<RichTextCommentProps>;
        update(params: OptionalDefaults<UpdateCommentParams>, rawData: UpdateCommentProps, headers?: AxiosRequestHeaders): Promise<CommentProps>;
        update(params: OptionalDefaults<UpdateCommentParams>, rawData: Omit<UpdateCommentProps, 'body'> & RichTextCommentBodyPayload, headers?: AxiosRequestHeaders): Promise<RichTextCommentProps>;
    ...
    entry: {
        getPublished<T extends KeyValueMap = KeyValueMap>(params: OptionalDefaults<GetSpaceEnvironmentParams & QueryParams>, rawData?: unknown, headers?: AxiosRequestHeaders): Promise<CollectionProp<EntryProps<T>>>;
        getMany<T extends KeyValueMap = KeyValueMap>(params: OptionalDefaults<GetSpaceEnvironmentParams & QueryParams>, rawData?: unknown, headers?: AxiosRequestHeaders): Promise<CollectionProp<EntryProps<T>>>;
    ...
    release: {
        ...
        unarchive(params: OptionalDefaults<GetReleaseParams & {
            version: number;
        }>): Promise<ReleaseProps>;
    ...
    appInstallation: {
        ...
        upsert(params: OptionalDefaults<GetAppInstallationParams>, rawData: CreateAppInstallationProps, headers?: AxiosRequestHeaders): Promise<AppInstallationProps>;
    ...
    extension: {
        ...
        create(params: OptionalDefaults<GetSpaceEnvironmentParams>, rawData: CreateExtensionProps, headers?: AxiosRequestHeaders): Promise<ExtensionProps>;
        createWithId(params: OptionalDefaults<GetExtensionParams>, rawData: CreateExtensionProps, headers?: AxiosRequestHeaders): Promise<ExtensionProps>;
        update(params: OptionalDefaults<GetExtensionParams>, rawData: ExtensionProps, headers?: AxiosRequestHeaders): Promise<ExtensionProps>;
    ...
    webhook: {
        ...
        create(params: OptionalDefaults<GetSpaceParams>, rawData: CreateWebhooksProps, headers?: AxiosRequestHeaders): Promise<WebhookProps>;
    ...
    snapshot: {
        getManyForEntry<T extends KeyValueMap = KeyValueMap>(params: OptionalDefaults<GetSnapshotForEntryParams & QueryParams>): Promise<CollectionProp<SnapshotProps<Omit<EntryProps<T>, 'metadata'>>>>;
    ...
    task: {
        ...
        create(params: OptionalDefaults<CreateTaskParams>, rawData: CreateTaskProps, headers?: AxiosRequestHeaders): Promise<TaskProps>;
        update(params: OptionalDefaults<UpdateTaskParams>, rawData: UpdateTaskProps, headers?: AxiosRequestHeaders): Promise<TaskProps>;
    ...
    uiConfig: {
        ...
        update(params: OptionalDefaults<GetUIConfigParams>, rawData: UIConfigProps): Promise<UIConfigProps>;
    };
    userUIConfig: {
        get(params: OptionalDefaults<GetUserUIConfigParams>): Promise<UserUIConfigProps>;
        update(params: OptionalDefaults<GetUserUIConfigParams>, rawData: UserUIConfigProps): Promise<UserUIConfigProps>;
    };
    workflowDefinition: {
        ...
        create(params: OptionalDefaults<CreateWorkflowDefinitionParams>, rawData: CreateWorkflowDefinitionProps, headers?: AxiosRequestHeaders): Promise<WorkflowDefinitionProps>;
        update(params: OptionalDefaults<UpdateWorkflowDefinitionParams>, rawData: UpdateWorkflowDefinitionProps, headers?: AxiosRequestHeaders): Promise<WorkflowDefinitionProps>;
    ...
    workflow: {
        ...
        create(params: OptionalDefaults<CreateWorkflowParams>, rawData: CreateWorkflowProps, headers?: AxiosRequestHeaders): Promise<WorkflowProps>;
        update(params: OptionalDefaults<UpdateWorkflowParams>, rawData: UpdateWorkflowProps, headers?: AxiosRequestHeaders): Promise<WorkflowProps>;
        delete(params: OptionalDefaults<DeleteWorkflowParams>, headers?: AxiosRequestHeaders): Promise<void>;
        complete(params: OptionalDefaults<CompleteWorkflowParams>, headers?: AxiosRequestHeaders): Promise<void>;
    };
    workflowsChangelog: {
        getMany(params: OptionalDefaults<GetSpaceEnvironmentParams & {
